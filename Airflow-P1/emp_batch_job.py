...
def process_data():
    ...
    bucket = "airflow-projects2"
    emp_data_path = f"gs://{bucket}/project1/data/employee.csv"
    dept_data_path = f"gs://{bucket}/project1/data/department.csv"
    output_path = f"gs://{bucket}/project1/joined_output"
